        ...
        <div class="w3-col l6  w3-right w3-center">
            ...
            <ul id="myUL" class="w3-ul w3-card-16 midnight-blue w3-show-inline-block" style="width:90%">
                ...
                <li class="w3-row  w3-center  " >
                    ...
                    <div class="w3-col l6 m6 w3-container w3-right w3-margin-bottom"><p dir="ltr"><span  class='w3-right'>تاریخ شروع: </span><input name="startDate" value="{{$match->startDate}}" type="text" class="my-input w3-input w3-margin-top border-bottom w3-transparent"></p></div>
                    <div class="w3-col l6 m6 w3-container w3-right w3-margin-bottom"><p dir="ltr"><span  class='w3-right'>تاریخ پایان: </span><input name="endDate" value="{{$match->endDate}}" type="text" class="my-input w3-input w3-margin-top border-bottom w3-transparent"></p></div>
                    <div class="w3-col l6 m6 w3-container w3-right w3-margin-bottom"><p dir="ltr"><span  class='w3-right'>تاریخ شروع ثبت نام: </span><input name="regStartDate" value="{{$match->regStartDate}}" type="text" class="my-input w3-input w3-margin-top border-bottom w3-transparent"></p></div>
                    <div class="w3-col l6 m6 w3-container w3-right w3-margin-bottom"><p dir="ltr"><span  class='w3-right'>تاریخ پایان ثبت نام: </span><input name="regEndDate" value="{{$match->regEndDate}}"  type="text" class="my-input w3-input w3-margin-top border-bottom w3-transparent"></p></div>
                ...
                @else
                    @foreach($refrees->all() as $refree)
                                <option  @foreach($match_refrees->all() as $match_refree)  @if($refree->id == $match_refree->id) selected @endif  @endforeach value="{{$refree->id}}">{{$refree->lastName}}&nbsp;{{$refree->firstName}}</option>
                     @endforeach
                    @endif
                    </select>
                    </p>
